...
ConfigureUSB(void)
{
    ...
    HWREG(SYSCTL_PLLFREQ0) = (SYSCTL_PLLFREQ0_PLLPWR | (96 << SYSCTL_PLLFREQ0_MINT_S));
    ...
    //
	HWREG(SYSCTL_MEMTIM0)  = (SYSCTL_MEMTIM0_FBCHT_3_5 | (5 << SYSCTL_MEMTIM0_FWS_S) |
    ...
    //
	HWREG(SYSCTL_RSCLKCFG) |= (SYSCTL_RSCLKCFG_MEMTIMU | SYSCTL_RSCLKCFG_USEPLL | 0x3);
#else
    //
